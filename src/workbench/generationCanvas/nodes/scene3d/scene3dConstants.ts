...
export const MANNEQUIN_POSE_PRESETS: MannequinPosePreset[] = [
  ...
  },
  {
    id: 'sit',
    label: '坐姿',
    // 坐在椅面高度：大腿水平、小腿垂直、脚掌踩平（脚 dorsiflex 28°，治此前 foot:4 脚尖下垂的「悬空尖脚」），
    // 躯干微前倾自然坐姿。Hips 归 0（它是骨架根，任何角度都整体歪身）。多视角校准见 .pose-lab。
    pose: makePoseOffset({
      mixamorigSpine: [6, 0, 0],
      mixamorigLeftUpLeg: [90, 3, 0],
      mixamorigRightUpLeg: [90, -3, 0],
      mixamorigLeftLeg: [88, 0, 0],
      mixamorigRightLeg: [88, 0, 0],
      mixamorigLeftFoot: [28, 0, 0],
      mixamorigRightFoot: [28, 0, 0],
    }),
  },
  {
    id: 'squat',
    label: '蹲下',
    // 深蹲：髋/膝深屈、躯干前倾压在膝上、脚掌踩平（foot 42°），不再脚尖点地+整体后仰。
    pose: makePoseOffset({
      mixamorigHips: [-6, 0, 0],
      mixamorigSpine: [26, 0, 0],
      mixamorigHead: [-8, 0, 0],
      mixamorigLeftUpLeg: [115, 6, 0],
      mixamorigRightUpLeg: [115, -6, 0],
      mixamorigLeftLeg: [125, 0, 0],
      mixamorigRightLeg: [125, 0, 0],
  ...
  },
  {
    id: 'single-knee',
    label: '单膝跪',
    // 前腿脚掌踩平（大腿水平、小腿垂直、foot 28）；后腿膝着地、小腿贴地后伸、脚背贴地
    // （foot 改负=跖屈把脚尖朝后压平，治此前 +40 背屈致后脚翘起整条腿悬空）。
    pose: makePoseOffset({
      mixamorigHips: [-4, 0, 0],
      ...
      mixamorigRightLeg: [100, 0, 0],
      mixamorigRightFoot: [38, 0, 0],
    }),
  },
  {
    id: 'double-knee',
